...
Процедура ПриОпределенииКомандПодключенныхКОбъекту(НастройкиФормы, Источники, ПодключенныеОтчетыИОбработки, Команды) Экспорт
	...
	//
	//Если НастройкиФормы.ИмяФормы = "Справочник.ДоговорыКонтрагентов.Форма.ФормаЭлемента" Тогда
	//	Команда = Команды.Добавить();
	//	Команда.Идентификатор = "КомандаНовая";
	//	Команда.Представление = "Команда новая";
	//	Команда.Обработчик = "МодификацияКонфигурацииВызовСервераПереопределяемый.СправочникДоговорыКонтрагентовФормаЭлементаКомандаНовая";
...
// Процедура СправочникДоговорыКонтрагентовФормаЭлементаКомандаНовая(Знач МассивСсылок, Знач ПараметрыВыполнения) Экспорт
//	 
